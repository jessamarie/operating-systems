...
public class VirtualMemoryTest {
	...
	private void runTest(String filename) throws IOException {
		...
		String inFilename = "src/project2/data/"+filename +".test"; // Input filename: [filename].test here  
		String expectedFilename ="src/project2/data/"+filename +".expected"; // Expected result filename: [filename].expected
		String outFilename = "src/project2/data/"+filename+".out"; // Output filename: [filename].out
